 ...
 */
  ...
  * @author Omayr
  */
 public class rfeg extends javax.swing.JFrame {
     ...
     public rfeg() {
         ...
         highlightSelectedButton(btnStudents);
     }
     ...
     private void highlightSelectedButton(javax.swing.JLabel selectedLabel) {
         ...
         btnModules.setOpaque(false);
         btnAssessments.setOpaque(false);
     ...
     private void initComponents() {
         ...
         btnTeachers = new javax.swing.JLabel();
         btnModules = new javax.swing.JLabel();
         btnAssessments = new javax.swing.JLabel();
         btnPayments = new javax.swing.JLabel();
         ...
         btnStudents.setBorder(javax.swing.BorderFactory.createEmptyBorder(15, 10, 15, 10));
         ...
         btnTeachers.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
         btnTeachers.setText("  Teachers");
         btnTeachers.setBorder(javax.swing.BorderFactory.createEmptyBorder(15, 10, 15, 10));
         ...
         btnModules.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
         btnModules.setText("  Modules");
         btnModules.setBorder(javax.swing.BorderFactory.createEmptyBorder(15, 10, 15, 10));
         btnModules.addMouseListener(new java.awt.event.MouseAdapter() {
             public void mouseClicked(java.awt.event.MouseEvent evt) {
                 btnModulesMouseClicked(evt);
             }
         });
         sidebarPanel.add(btnModules);
 
         btnAssessments.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
         btnAssessments.setText("  Assessments");
         btnAssessments.setBorder(javax.swing.BorderFactory.createEmptyBorder(15, 10, 15, 10));
         btnAssessments.addMouseListener(new java.awt.event.MouseAdapter() {
             public void mouseClicked(java.awt.event.MouseEvent evt) {
                 btnAssessmentsMouseClicked(evt);
             }
         });
         sidebarPanel.add(btnAssessments);
 
         btnPayments.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
         btnPayments.setText("  Payments");
         btnPayments.setBorder(javax.swing.BorderFactory.createEmptyBorder(15, 10, 15, 10));
     ...
     private void btnTeachersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTeachersMouseClicked
         ...
         highlightSelectedButton(btnTeachers);
     }//GEN-LAST:event_btnTeachersMouseClicked
 
     private void btnModulesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModulesMouseClicked
         cardLayout.show(contentPanel, "modules");
         highlightSelectedButton(btnModules);
     }//GEN-LAST:event_btnModulesMouseClicked
 
     private void btnAssessmentsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAssessmentsMouseClicked
         cardLayout.show(contentPanel, "assessments");
         highlightSelectedButton(btnAssessments);
     }//GEN-LAST:event_btnAssessmentsMouseClicked
     ...
     private void btnPaymentsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPaymentsMouseClicked
         ...
         highlightSelectedButton(btnPayments);
     ...
     public static void main(String args[]) {
         ...
         try {
             ...
             java.util.logging.Logger.getLogger(rfeg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
         ...
         java.awt.EventQueue.invokeLater(new Runnable() {
             public void run() {
                 new rfeg().setVisible(true);
             }
         });
     }
 
     // Variables declaration - do not modify//GEN-BEGIN:variables
     private javax.swing.JLabel btnAssessments;
     private javax.swing.JButton btnLogout;
     private javax.swing.JLabel btnModules;
     private javax.swing.JLabel btnPayments;
     private javax.swing.JLabel btnStudents;
     private javax.swing.JLabel btnTeachers;
